...
FILE_ORDER = {
    ...
    "test_home_hot_route_play_mode_sidebar_post.py": 13,
    "test_home_hot_route_play_mode_location.py": 14,
    "test_home_hot_route_play_mode_poi_detail.py": 15,
    "test_home_hot_route_join_trip.py": 16,
    "test_home_service_tabs.py": 17,
    "test_taxi_service_entry.py": 18,
    "test_scenic_youtube_entries.py": 19,
    "test_local_service_categories.py": 20,
    "test_local_service_search.py": 21,
    "test_food_ordering_categories.py": 22,
    "test_food_ordering_search.py": 23,
    "test_search_start_page_interactions.py": 24,
    "test_search_scope_by_destination.py": 25,
    "test_search_result_groups.py": 26,
    "test_poi_add_to_trip.py": 27,
    "test_poi_hotel_booking_and_navigation.py": 28,
    "test_poi_recommendation_post.py": 29,
    "test_favorite_poi_from_ranking.py": 30,
    "test_home_guide_like_persistence.py": 31,
    "test_home_post_favorite_collection.py": 32,
    "test_multitask_management.py": 33,
    "test_multitask_return_home.py": 34,
    "test_destination_selector_browse.py": 35,
    "test_destination_switch_refresh.py": 36,
    "test_clear_search_history.py": 37,
}
